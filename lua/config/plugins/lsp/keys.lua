...
function M.setup(client, bufnr)
  local vim = vim
      ...
      vim.keymap.set('n', 'K', function(bufnr)
        ...
        vim.keymap.set('n', 'gd', function() require('fzf-lua').lsp_definitions() end, bufopts)
        vim.keymap.set('n', '<leader>i', function() require('fzf-lua').lsp_implementations() end, bufopts)
