...
function M.config()
	...
	-- -- For fzf-lua
	set_keymap({ 'v', 'n' }, '<leader>fb', function()
		require('fzf-lua').buffers()
	end, { desc = 'Fzf: Buffers' })
	set_keymap({ 'v', 'n' }, '<leader>ff', function()
		require('fzf-lua').files()
	end, { desc = 'Fzf: Files' })
	set_keymap({ 'v', 'n' }, '<leader>fg', function()
		require('fzf-lua').live_grep()
	end, { desc = 'Fzf: Grep' })
	set_keymap({ 'v', 'n' }, '<leader>ft', function()
		require('fzf-lua').tags()
	end, { desc = 'Fzf: Tags' })
	set_keymap({ 'v', 'n' }, '<leader>fc', function()
		require('fzf-lua').git_bcommits()
	end, { desc = 'Fzf: BCommits' })
	set_keymap({ 'v', 'n' }, '<leader>fm', function()
		require('fzf-lua').marks()
	end, { desc = 'Fzf: manpages' })
	set_keymap({ 'v', 'n' }, '<leader>fr', function()
		require('fzf-lua').lsp_references { sync = true, jump_to_single_result = true }
	end, { desc = 'Fzf: References' })
	set_keymap({ 'v', 'n' }, '<leader>fs', function()
		require('fzf-lua').lsp_definitions { sync = true, jump_to_single_result = true }
	end, { desc = 'Fzf: definitions' })
	set_keymap({ 'v', 'n' }, '<leader>fh', function()
		require('fzf-lua').help_tags()
	end, { desc = 'Fzf: help tags' })
	set_keymap({ 'v', 'n' }, '<leader>fv', function()
