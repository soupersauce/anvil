...
if (fn.executable('siyoek') == 1) then
  ...
  knapsettings["orgtopdfviewerlaunch"] = "sioyek --inverse-search 'nvim --headless-es --cmd \"lua require('\"'\"'knaphelper'\"'\"').relayjump('\"'\"'%servername%'\"'\"','\"'\"'%1'\"'\"',%2,0)\"' --reuse-instance %outputfile%"
  knapsettings["orgtopdfviewerrefresh"] = "none"
  knapsettings["orgtopdfforwardjump"] = "sioyek --inverse-search 'nvim --headless -es --cmd \"lua require('\"'\"'knaphelper'\"'\"').relayjump('\"'\"'%servername%'\"'\"','\"'\"'%1'\"'\"',%2,0)\"' --reuse-instance --forward-search-file %srcfile% --forward-search-line %line% %outputfile%"
...
elseif (fn.executable('qpdfview')) then
  ...
  knapsettings["orgtopdfviewerrefresh"] = "none"
  knapsettings["orgtopdfforwardjump"] = "qpdfview --unique --instance neovim %outputfile%#src:%srcfile%:%line%:%column%"
